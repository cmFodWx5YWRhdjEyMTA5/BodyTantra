...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String str= YourPreference.getInstance(this).getData("log");
        Log.d("logvalue",str);
        if(str.equals("yes")){
...
forgotpassword.setOnClickListener(new View.OnClickListener() {
    ...
    private void verifyFromSQLite() {
        ...
        if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim()
           ...
           // accountsIntent.putExtra("classnum",1);
           // accountsIntent.putExtra("name".getText().toString());
            YourPreference.getInstance(this).saveData("email",textInputEditTextEmail.getText().toString());
